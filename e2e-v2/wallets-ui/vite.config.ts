...
// Workspace-path workaround. Paths are relative to this file (e2e-v2/wallets-ui/).
...
// Browser-safe config — the real @e2e-v2/data-types/config-localhost reads
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@e2e-v2/midnight-contract-eip-20/contract": midnightContractEip20Path + "index.js",
      "@e2e-v2/midnight-contract-counter-basic/contract": midnightContractCounterBasicPath + "index.js",
      ...
      "@e2e-v2/data-types/config-localhost": browserConfigPath,
      "@e2e-v2/data-types": dataTypesPath + "src/mod.ts",
