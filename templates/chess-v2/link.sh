...
link_pkg "chess-v2" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "chess-v2" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "chess-v2" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "chess-v2" "batcher"         "$SCRIPT_DIR/packages/batcher"
link_pkg "chess-v2" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "chess-v2" "tests"           "$SCRIPT_DIR/packages/tests"
