/** Types generated for queries found in "sql/insert.sql" */
...
const newRoundIR: any = {"usedParamSet":{"lobby_id":true,"round_within_match":true,"match_state":true,"player_one_blocks_left":true,"player_two_blocks_left":true,"starting_block_height":true,"execution_block_height":true},"params":[{"name":"lobby_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":183,"b":192}]},{"name":"round_within_match","required":true,"transform":{"type":"scalar"},"locs":[{"a":197,"b":216}]},{"name":"match_state","required":true,"transform":{"type":"scalar"},"locs":[{"a":221,"b":233}]},{"name":"player_one_blocks_left","required":true,"transform":{"type":"scalar"},"locs":[{"a":238,"b":261}]},{"name":"player_two_blocks_left","required":true,"transform":{"type":"scalar"},"locs":[{"a":266,"b":289}]},{"name":"starting_block_height","required":true,"transform":{"type":"scalar"},"locs":[{"a":294,"b":316}]},{"name":"execution_block_height","required":false,"transform":{"type":"scalar"},"locs":[{"a":321,"b":343}]}],"statement":"INSERT INTO rounds(\n  lobby_id,\n  round_within_match,\n  match_state,\n  player_one_blocks_left,\n  player_two_blocks_left,\n  starting_block_height,\n  execution_block_height)\nVALUES (\n  :lobby_id!,\n  :round_within_match!,\n  :match_state!,\n  :player_one_blocks_left!,\n  :player_two_blocks_left!,\n  :starting_block_height!,\n  :execution_block_height)\nRETURNING *"};
