...
const startMatchIR: any = {
  "usedParamSet": { "player_two": true, "lobby_id": true },
  "params": [{
    "name": "player_two",
    "required": true,
 ...
 * ```
 */
export const startMatch = new PreparedQuery<
  IStartMatchParams,
  IStartMatchResult
>(startMatchIR);
 ...
 * ```
 */
export const closeLobby = new PreparedQuery<
  ICloseLobbyParams,
  ICloseLobbyResult
>(closeLobbyIR);
...
const updateLatestMatchStateIR: any = {
  "usedParamSet": { "latest_match_state": true, "lobby_id": true },
  "params": [{
 ...
 * ```
 */
export const updateLatestMatchState = new PreparedQuery<
  IUpdateLatestMatchStateParams,
  IUpdateLatestMatchStateResult
>(updateLatestMatchStateIR);
 ...
 * ```
 */
export const endMatch = new PreparedQuery<IEndMatchParams, IEndMatchResult>(
  endMatchIR,
);
 ...
 * ```
 */
export const executedRound = new PreparedQuery<
  IExecutedRoundParams,
  IExecutedRoundResult
>(executedRoundIR);
