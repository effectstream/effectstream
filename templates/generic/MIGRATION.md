...
`/home/eddie/paima-game-templates/generic` to `@effectstream/*` (Bun 0.100.18).

## Source
- Repo: `/home/eddie/paima-game-templates/generic`
...
5. `LINK_LOCAL=1 bun run templates/run-template-tests.ts generic` exit 0
