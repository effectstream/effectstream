...
link_pkg "generic" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "generic" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "generic" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "generic" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "generic" "tests"           "$SCRIPT_DIR/packages/tests"
...
link_pkg "effectstream" "db-emulator"       "$P/node-sdk/db-emulator"
