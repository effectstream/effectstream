...
link_pkg "shinkai-v2" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "shinkai-v2" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "shinkai-v2" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "shinkai-v2" "batcher"         "$SCRIPT_DIR/packages/batcher"
link_pkg "shinkai-v2" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "shinkai-v2" "tests"           "$SCRIPT_DIR/packages/tests"
