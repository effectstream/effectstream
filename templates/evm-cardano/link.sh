...
link_pkg "evm-cardano" "contracts-evm"        "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "evm-cardano" "contracts-cardano"     "$SCRIPT_DIR/packages/contracts-cardano"
link_pkg "evm-cardano" "database"              "$SCRIPT_DIR/packages/database"
link_pkg "evm-cardano" "node"                  "$SCRIPT_DIR/packages/node"
link_pkg "evm-cardano" "frontend"              "$SCRIPT_DIR/packages/frontend"
link_pkg "evm-cardano" "tests"                 "$SCRIPT_DIR/packages/tests"
