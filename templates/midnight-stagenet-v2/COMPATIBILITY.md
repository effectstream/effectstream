...
`hostedIntegratedTemplateVerification` is `validated`. Authorized C19 run `c19-hosted-20260810-24720` deployed `CryptoEventSink` at `f548223c6c73ed1fb535ce84326c3c4d4696ea7023a8af8ecafe5139117e5907` and `FeatureGateway` at `b2872b4ec54d1a3d9b74c02b8edcc9987028f814918cffcc7da2cc41428a7f8a`. Root transaction `ff60ee5657415fc331c6d0532ba412301e2850b80d28d71d26af3727a51f6aad` finalized at block 458784 and called sink then gateway. The sink returned and stored Keccak-256 digest `290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e563`; its one local `Unpaused` event matched one API-v4 indexed event. Effectstream ran with network identity `stagenet`, persisted the event once, then rejected the overlap replay without adding a row. The evidence contains public chain data only.
