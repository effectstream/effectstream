...
link_pkg "world-map-2d" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "world-map-2d" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "world-map-2d" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "world-map-2d" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "world-map-2d" "tests"           "$SCRIPT_DIR/packages/tests"
