...
link_pkg "dice" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "dice" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "dice" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "dice" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "dice" "tests"           "$SCRIPT_DIR/packages/tests"
