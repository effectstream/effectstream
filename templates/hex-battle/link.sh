...
link_pkg "hex-battle" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "hex-battle" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "hex-battle" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "hex-battle" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "hex-battle" "tests"           "$SCRIPT_DIR/packages/tests"
