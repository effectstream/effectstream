...
const insertEvmMidnightIR: any = {"usedParamSet":{"contract_address":true,"token_id":true,"owner":true,"block_height":true},"params":[{"name":"contract_address","required":true,"transform":{"type":"scalar"},"locs":[{"a":91,"b":108}]},{"name":"token_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":111,"b":120}]},{"name":"owner","required":true,"transform":{"type":"scalar"},"locs":[{"a":123,"b":129}]},{"name":"block_height","required":true,"transform":{"type":"scalar"},"locs":[{"a":132,"b":145}]}],"statement":"INSERT INTO evm_midnight\n    (contract_address, token_id, owner, block_height)\nVALUES\n    (:contract_address!, :token_id!, :owner!, :block_height!)\nON CONFLICT (contract_address, token_id)\nDO UPDATE SET\n    owner = EXCLUDED.owner,\n    block_height = EXCLUDED.block_height"};
...
const insertEvmMidnightPropertyIR: any = {"usedParamSet":{"contract_address":true,"token_id":true,"property_name":true,"value":true,"block_height":true},"params":[{"name":"contract_address","required":true,"transform":{"type":"scalar"},"locs":[{"a":117,"b":134}]},{"name":"token_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":137,"b":146}]},{"name":"property_name","required":true,"transform":{"type":"scalar"},"locs":[{"a":149,"b":163}]},{"name":"value","required":true,"transform":{"type":"scalar"},"locs":[{"a":166,"b":172}]},{"name":"block_height","required":true,"transform":{"type":"scalar"},"locs":[{"a":175,"b":188}]}],"statement":"INSERT INTO evm_midnight_properties\n    (contract_address, token_id, property_name, value, block_height)\nVALUES\n    (:contract_address!, :token_id!, :property_name!, :value!, :block_height!)\nON CONFLICT (contract_address, token_id, property_name)\nDO UPDATE SET\n    value = EXCLUDED.value,\n    block_height = EXCLUDED.block_height"};
...
const getEvmMidnightByTokenIdIR: any = {"usedParamSet":{"token_id":true,"contract_address":true},"params":[{"name":"token_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":57,"b":66}]},{"name":"contract_address","required":true,"transform":{"type":"scalar"},"locs":[{"a":104,"b":121}]}],"statement":"SELECT * FROM evm_midnight\nWHERE evm_midnight.token_id = :token_id!\nAND evm_midnight.contract_address = :contract_address!"};
