...
link_pkg "rock-paper-scissors" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "rock-paper-scissors" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "rock-paper-scissors" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "rock-paper-scissors" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "rock-paper-scissors" "tests"           "$SCRIPT_DIR/packages/tests"
