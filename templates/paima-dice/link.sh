...
link_pkg "paima-dice" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "paima-dice" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "paima-dice" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "paima-dice" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "paima-dice" "tests"           "$SCRIPT_DIR/packages/tests"
