# web-2.5 — migration plan

Group C: port from `@paima/*` (paima-engine-v1) at
`/home/eddie/paima-game-templates/web-2.5` to `@effectstream/*` (Bun 0.100.18).

## Source
- Repo: `/home/eddie/paima-game-templates/web-2.5`
...
5. `LINK_LOCAL=1 bun run templates/run-template-tests.ts web-2.5` exit 0
