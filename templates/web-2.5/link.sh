...
link_pkg "web-2.5" "batcher"       "$SCRIPT_DIR/packages/batcher"
link_pkg "web-2.5" "contracts-evm" "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "web-2.5" "database"      "$SCRIPT_DIR/packages/database"
link_pkg "web-2.5" "frontend"      "$SCRIPT_DIR/packages/frontend"
link_pkg "web-2.5" "node"          "$SCRIPT_DIR/packages/node"
link_pkg "web-2.5" "tests"         "$SCRIPT_DIR/packages/tests"
