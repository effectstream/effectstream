...
import {
  ...
  export type MultiChainContract = Contract<PrivateState, typeof unshielded_erc20Witnesses>;
  ...
  const simpleTokenContractInstance = new SimpleToken
    .Contract(
  ...
  const configureProviders = async (
    ...
    const injectedWalletAndSimpleTokenProvider = await createWalletAndSimpleTokenProvider(
      injectedWallet,
    );
  ...
  class SimpleTokenAlternativeLogin {
