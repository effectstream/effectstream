...
The EffectStream Explorer is typically launched automatically as part of the local development environment when you run `bun run dev`. It is configured as an entry in the `processes` array of your `start.dev.ts` file.
