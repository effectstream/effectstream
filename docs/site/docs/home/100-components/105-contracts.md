...
More in the [Paima L2 Contract Section](./104-paima-l2-contract.md)

### Paima-Provided Contracts
The `@paima/evm-contracts` package includes a variety of useful contracts, including implementations of common standards and the core `PaimaL2Contract`.
