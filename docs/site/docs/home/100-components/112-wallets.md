...
| :--- | :--- | :--- |
| **`EvmInjected`** | EVM | Standard injected browser wallets (MetaMask, Rabby, etc.). |
| **`EvmEthers`** | EVM | Connect using an Ethers.js provider instance. |
| **`Cardano`** | Cardano | Connects to Cardano wallets like Nami, Eternl, etc. |
