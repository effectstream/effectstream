---
title: "@effectstream/runtime"
description: "State machine runtime for EffectStream"
...
Implementation: [`src/coalesce.ts`](https://github.com/effectstream/effectstream/blob/main/packages/node-sdk/runtime/src/coalesce.ts) (the `createEmptyBlockCoalescer`
