---
title: "Chess"
description: "A complete turn-based chess game on an EVM chain: lobbies, matchmaking, move validation, chess clocks and ELO, driven by scheduled state transitions."
sidebar_label: "Chess"
sidebar_position: 8
---

<!-- Generated from templates/chess-v2/README.md by docs/site/scripts/sync-template-readmes.ts. Do not edit directly. -->

> Template: **[`templates/chess-v2`](https://github.com/effectstream/effectstream/tree/main/templates/chess-v2)**
