---
title: "EVM-Cardano Explorer"
description: "Syncs an EVM chain and a Cardano devnet side by side into one deterministic state machine, and shows both event streams in a single dashboard."
sidebar_label: "EVM-Cardano Explorer"
sidebar_position: 4
---

<!-- Generated from templates/evm-cardano/README.md by docs/site/scripts/sync-template-readmes.ts. Do not edit directly. -->

> Template: **[`templates/evm-cardano`](https://github.com/effectstream/effectstream/tree/main/templates/evm-cardano)**
