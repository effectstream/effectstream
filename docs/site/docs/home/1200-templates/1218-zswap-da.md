---
title: "ZSwap Offerfile Kernel (frontend)"
description: "A React frontend for atomic token swaps on Midnight, where open offers live as Celestia data-availability blobs rather than in an on-chain order book."
sidebar_label: "ZSwap Offerfile Kernel (frontend)"
sidebar_position: 16
---

<!-- Generated from templates/zswap-da/README.md by docs/site/scripts/sync-template-readmes.ts. Do not edit directly. -->

> Template: **[`templates/zswap-da`](https://github.com/effectstream/effectstream/tree/main/templates/zswap-da)**
