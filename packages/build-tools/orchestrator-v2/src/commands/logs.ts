 ...
 *
 *   orchestrator-v2 logs                   # follow all logs
 *   orchestrator-v2 logs sync batcher      # follow only sync.log and batcher.log
 *   orchestrator-v2 logs --log-dir=./logs  # custom log directory
 */
