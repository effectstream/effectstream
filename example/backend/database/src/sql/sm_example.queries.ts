...
const insertStateMachineInputIR: any = {
  "usedParamSet": { "inputs": true, "block_height": true },
  "params": [{
    "name": "inputs",
    "required": true,
 ...
 * ```
 */
export const insertStateMachineInput = new PreparedQuery<
  IInsertStateMachineInputParams,
  IInsertStateMachineInputResult
 ...
 * ```
 */
export const getStateMachineInput = new PreparedQuery<
  IGetStateMachineInputParams,
  IGetStateMachineInputResult
>(getStateMachineInputIR);
 ...
 * ```
 */
export const getStateMachineInputByBlockHeight = new PreparedQuery<
...
const getLastSumFromExampleTableIR: any = {
  "usedParamSet": {},
  "params": [],
  "statement":
 ...
 * ```
 */
export const getLastSumFromExampleTable = new PreparedQuery<
  IGetLastSumFromExampleTableParams,
  IGetLastSumFromExampleTableResult
>(getLastSumFromExampleTableIR);
...
const insertSumIntoExampleTableIR: any = {
  "usedParamSet": { "sum": true, "block_height": true },
  "params": [{
    "name": "sum",
    "required": true,
    "transform": { "type": "scalar" },
 ...
 * ```
 */
export const insertSumIntoExampleTable = new PreparedQuery<
  IInsertSumIntoExampleTableParams,
  IInsertSumIntoExampleTableResult
>(insertSumIntoExampleTableIR);
