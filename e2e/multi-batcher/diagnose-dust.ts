...
//
//   docker compose -f e2e/multi-batcher/docker-compose.yml up -d
//   bun run e2e/multi-batcher/diagnose-dust.ts -- --seed product-a
//   bun run e2e/multi-batcher/diagnose-dust.ts -- --seed genesis --watch 120

import { setNetworkId } from "@midnight-ntwrk/midnight-js-network-id";
import * as Rx from "rxjs";

import { ACTOR_SEEDS, GENESIS_SEED, NETWORK, PRODUCT_SEEDS } from "./env.ts";
